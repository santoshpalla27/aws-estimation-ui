...
export default function S3Calculator({ serviceId }) {
    ...
    return (
        <div className="card">
            <div className="header">
                <h1><HardDrive size={32} style={{ marginRight: '0.5rem', marginBottom: '-6px' }} /> S3 Estimator</h1>
            </div>
            ...
            <div style={{ display: 'grid', gap: '1rem', maxWidth: '600px' }}>
                ...
                <div>
                    <label className="label">Storage Amount (GB)</label>
                    <input
                        type="number"
                        className="input"
